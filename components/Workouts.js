    ...
    <div className='bg-white'>
      <div className='mx-auto px-4 max-w-7xl sm:px-6 lg:px-8 py-8'>
        <div className='space-y-12'>
          ...
          <ul
            role='list'
            className='space-y-6 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-6 sm:space-y-0 lg:grid-cols-3 lg:gap-x-8'
          >
              ...
              <li key={workout.name}>
                <div className='relative space-y-1'>
                  ...
                  <div className='space-y-2'>
                    <div className='absolute bottom-5 left-5 text-lg leading-6 font-medium space-y-1'>
